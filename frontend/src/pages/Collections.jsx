      ...
      <div className="lg:pl-[20%] md:py-[10px] ">
        <div className=" md:w-[80vw] w-[100vw]    flex  justify-between flex-col lg:flex-row lg:px-[50px] ml-[100px] mt-[20px] md:mt-0">
          ...
          <select
            name=""
            id=""
            className="bg-slate-600 w-[60%] md:w-[200px] h-[50px] px-[10px] text-[white] rounded-lg hover:border-[#46d1f7] border-[2px] mr-[50px] mb-[20px] md:mt-0 md:mr-[100px]"
        ...
        <div className="lg:w-[80vw] md:w-[60vw]   w-[100vw] min-h-[70vh] flex items-center justify-center flex-wrap gap-[30px] mt-[5px]">
