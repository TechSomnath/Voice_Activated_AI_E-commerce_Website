      ...
      <div className="w-[100%] h-[100%] flex items-center justify-start">
        ...
        <div className="w-[82%] h-[100%] lg:ml-[320px] md:ml-[230px] mt-[70px] flex flex-col gap-[30px] overflow-x-hidden py-[50px] ml-[100px]">
          ...
          {list?.length > 0 ? (
            list.map((item, index) => (
              <div
                className="w-[90%] md:h-[120px] h-[90px] bg-slate-600 rounded-xl flex items-center justify-start gap-[5px] md:gap-[30px] p-[10px] md:px-[30px] ml-[100px]"
                key={index}
              >
                <img
                  src={item.image1}
            ...
            <div className="text-white text-lg ml-[100px]">No products available.</div>
          )}
        </div>
      </div>
    </div>
